...
## Installation
[Canvas](https://github.com/joe-herbert/canvas-cli/blob/main/canvas) CLI is a bash script, so you can just download it somewhere and make sure it's added to your `$PATH`.  
